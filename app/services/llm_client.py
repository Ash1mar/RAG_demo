...
TASK_QUERY_SYSTEM_PROMPT = (
    ...
    "- When the user asks \"什么时候完成/搞定/结束\", set answer_mode to "
    "\"completion_time_latest\", force status to [\"DONE\"], and limit to 1 "
    "(latest ts).\n"
    "- When multiple people are mentioned, move them into filters with "
    "{\"field\":\"person\",\"op\":\"in\",\"values\":[...]}, and clear the top-level person field.\n"
    "- When priority keywords (P0/P1/高优/低优) or time phrases "
    "(本周/最近 N 天/截止/到期) appear, populate priority, time_range, or due_range accordingly.\n"
